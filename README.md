...
**Math Magicians** is a HTML, CSS and JavaScript project that displays a friendly interface for performing math calculations via a nice web application
...
```
git clone yourlink repo https://github.com/alexansaa/LeaderBoard.git
